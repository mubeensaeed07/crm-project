                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        @endif
                                        @if($permissions['can_mark_salary_paid'])
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-check-circle text-success me-2"></i>
                                                <span>Mark Salary Paid</span>
                                            </div>
                                        @endif
                                        @if($permissions['can_mark_salary_pending'])
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-check-circle text-success me-2"></i>
                                                <span>Mark Salary Pending</span>
                                            </div>
                                        @endif
                                        @if($permissions['can_view_salary_data'])
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-check-circle text-success me-2"></i>
                                                <span>View Salary Data</span>
                                            </div>
                                        @endif
                                        @if($permissions['can_manage_salary_payments'])
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-check-circle text-success me-2"></i>
                                                <span>Manage Salary Payments</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <a href="{{ route('hrm.users.create') }}" class="btn btn-sm btn-success">Create</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <a href="{{ route('hrm.users.index') }}" class="btn btn-sm btn-warning">Manage</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <a href="{{ route('hrm.dashboard') }}" class="btn btn-sm btn-info">Reports</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <a href="{{ route('hrm.users.index') }}" class="btn btn-sm btn-primary">Reset</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <h6 class="card-title">Mark Salary Paid</h6>
                                                        <p class="text-muted fs-13">Mark employee salaries as paid</p>
                                                        <a href="{{ route('finance.dashboard') }}" class="btn btn-sm btn-success">Finance</a>
                                        </div>
                                        </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3">
                                                <div class="card custom-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <h6 class="card-title">View Salary Data</h6>
                                                        <p class="text-muted fs-13">View salary information and reports</p>
                                                        <a href="{{ route('finance.dashboard') }}" class="btn btn-sm btn-info">View Data</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    @if(!$permissions['can_create_users'] && !$permissions['can_edit_users'] && !$permissions['can_view_reports'] && !$permissions['can_reset_passwords'] && !$permissions['can_mark_salary_paid'] && !$permissions['can_view_salary_data'])
