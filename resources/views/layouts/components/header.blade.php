                                ...
                                <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="{{url('notifications')}}">Discount Available</a></p>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="{{url('notifications')}}">Order Delayed <span class="text-success">ID: 7731116</span></a></p>
