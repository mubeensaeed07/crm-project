                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="collapse navbar-collapse navbar-justified flex-wrap gap-2" id="navbarSupportedContent">
                                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-xxl-center">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0);" class="nav-link"><i class="ri-customer-service-line me-2 align-middle d-inline-block"></i>Support</a>
                                                        </li>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/1.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                                    <a href="{{url('products-details')}}" class="view"><i class="ri-eye-line"></i></a>
                                                </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/2.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/3.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/4.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/5.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/6.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/7.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/8.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/9.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/10.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/11.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card product-card">
                                            <div class="card-body">
                                                <a href="{{url('products-details')}}" class="product-image">
                                                    <img src="{{asset('build/assets/images/ecommerce/png/12.png')}}" class="card-img mb-3" alt="...">
                                                </a>
                                                <div class="product-icons">
                                                    <a href="{{url('wishlist')}}" class="wishlist"><i class="ri-heart-line"></i></a>
                                                    <a href="{{url('cart')}}" class="cart"><i class="ri-shopping-cart-line"></i></a>
