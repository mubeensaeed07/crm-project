                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                    ...
                    <div class="card custom-card">
                        <div class="card-body p-5">
                            <p class="h5 fw-semibold mb-2 text-center">CRM Registration</p>
                            <p class="mb-4 text-muted op-7 fw-normal text-center">Create your CRM account</p>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="first_name" name="first_name" value="{{ old('first_name') }}" placeholder="Enter first name" required>
                                    </div>
                                    <div class="col-xl-6">
                                        <label for="last_name" class="form-label text-default">Last Name</label>
                                        <input type="text" class="form-control form-control-lg" id="last_name" name="last_name" value="{{ old('last_name') }}" placeholder="Enter last name" required>
                                    </div>
                                    <div class="col-xl-12">
                            ...
                            <div class="text-center">
                                <p class="fs-13 text-muted mt-3">Already have an account? <a href="{{ route('login') }}" class="text-primary fw-semibold text-decoration-underline">Sign In</a></p>
                            </div>

                            <div class="text-center mt-3">
                                <a href="{{ route('google.login') }}" class="btn btn-outline-primary">
                                    <i class="bx bxl-google me-2"></i>Sign up with Google
                                </a>
                            </div>
                        </div>
                    </div>
